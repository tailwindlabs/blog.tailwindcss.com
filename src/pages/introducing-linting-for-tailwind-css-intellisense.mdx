...
import imgCss from '@/img/linting/css.png'
import imgCss2x from '@/img/linting/css@2x.png'
import imgHtml from '@/img/linting/html.png'
import imgHtml2x from '@/img/linting/html@2x.png'
...
<img
  ...
  sizes="(min-width: 640px) calc(100vw - 3rem), (min-width: 768px) 45rem, (min-width: 1280px) 51rem, calc(100vw - 2rem)"
/>
