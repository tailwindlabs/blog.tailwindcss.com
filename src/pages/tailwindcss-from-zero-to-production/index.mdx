...
export const meta = {
  ...
  date: '2021-02-16:00:00.000Z',
  authors: [simonswiss],
  image,
  footer: `
    <p>
      What are you waiting for?
      <a href="https://www.youtube.com/watch?v=elgqxmdVms8&list=PL5f_mz_zU5eXWYDXHUDOLBE0scnuJofO0&index=1" class="font-medium text-teal-500 hover:text-teal-600">
        Start watching →
      </a>
    </p>
  `,
...
4. [Hover, Focus and Other States](://www.youtube.com/watch?v=5_BPDve5-3M)
5. [Composing Utilities with @apply](https://www.youtube.com/watch?v=TrftauE2Vyk)
6. [Extracting Reusable Components](://www.youtube.com/watch?v=v-mkUxhaFVA)
